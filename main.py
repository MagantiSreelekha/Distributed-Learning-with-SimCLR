...
from contrastivelearning import CLDataset
...
parser.add_argument('--temperature', default=0.09, type=float, help='softmax temperature (default: 0.07)')
parser.add_argument('--n-views', default=2, type=int, metavar='N',help='Number of views for contrastive learning training. Only two view training is supported. Please use --n-views 2.')
...
def main():
    ...
    if not args.disable_cuda and torch.cuda.is_available(): #checking if GPU is available
